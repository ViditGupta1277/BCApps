...
table 6794 "WHT Threshold Accumulator"
{
    ...
    fields
    {
        ...
        field(8; "Expense Category Code"; Code[20])
        {
            Caption = 'Expense Category Code';
        }
        field(9; "Accumulated Base Amount"; Decimal)
        {
            Caption = 'Accumulated Base Amount';
            AutoFormatType = 1;
        }
        field(10; "Accumulated WHT Amount"; Decimal)
        {
    ...
    keys
    {
        ...
        key(Key2; "Employee No.", "Threshold Base", "Expense Category Code", "Period Start Date", "Period End Date")
        {
